...
function Home() {
  ...
  return (
    <div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 mb-4">
                <div className="trend-item rounded box-shadow">
                  ...
                  <div className="trend-content p-4 pt-5 position-relative">
                    ...
                    <h5 className="theme mb-1"><i className="flaticon-location-pin" /> Croatia</h5>
                    ...
                    <p className=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in voluptate velit
                      esse cillum</p>
                    <div className="entry-meta">
                      <div className="entry-author d-flex align-items-center">
                        <p className="mb-0"><span className="theme fw-bold fs-5"> $170.00</span> | Per person
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 mb-4">
                <div className="trend-item box-shadow rounded">
                  ...
                  <div className="trend-content p-4 pt-5 position-relative">
                    ...
                    <h5 className="theme mb-1"><i className="flaticon-location-pin" /> Greece</h5>
                    ...
                    <div className="entry-meta">
                      <div className="entry-author d-flex align-items-center">
                        <p className="mb-0"><span className="theme fw-bold fs-5"> $180.00</span> | Per person
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 mb-4">
                <div className="trend-item box-shadow rounded">
                  ...
                  <div className="trend-content p-4 pt-5 position-relative">
                    ...
                    <h5 className="theme mb-1"><i className="flaticon-location-pin" /> Maldives</h5>
                    ...
                    <div className="entry-meta">
                      <div className="entry-author d-flex align-items-center">
                        <p className="mb-0"><span className="theme fw-bold fs-5"> $260.00</span> | Per person
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* <section className="discount-action pt-6" style={{backgroundImage: 'url(images/section-bg1.png)', backgroundPosition: 'center'}}>
                ...
                <div className="row">
                  <div className="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div className="trend-item rounded box-shadow bg-white">
                      <div className="trend-image position-relative">
                        <img src="/assets/images/trending/trending3.jpg" alt="image" className />
                        <div className="ribbon ribbon-top-left"><span className="fw-bold">20% OFF</span></div>
                        <div className="color-overlay" />
                      </div>
                      <div className="trend-content p-4 pt-5 position-relative">
                        <div className="trend-meta bg-theme white px-3 py-2 rounded">
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div className="trend-item box-shadow rounded bg-white">
                      <div className="trend-image position-relative">
                        <img src="/assets/images/trending/trending1.jpg" alt="image" />
                        <div className="ribbon ribbon-top-left"><span className="fw-bold">30% OFF</span></div>
                        <div className="color-overlay" />
                      </div>
                      <div className="trend-content p-4 pt-5 position-relative">
                        <div className="trend-meta bg-theme white px-3 py-2 rounded">
                  ...
                  <div className="col-lg-4 mb-4">
                    <div className="trend-item box-shadow rounded bg-white">
                      <div className="trend-image position-relative">
                        ...
                        <div className="ribbon ribbon-top-left"><span className="fw-bold">15% OFF</span></div>
                        <div className="color-overlay" />
                      </div>
                      <div className="trend-content p-4 pt-5 position-relative">
                        <div className="trend-meta bg-theme white px-3 py-2 rounded">
