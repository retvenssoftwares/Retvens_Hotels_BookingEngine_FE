...
function Room({ totalAmount, setTotalAmount }) {
  ...
  return (
    <>
      <section>
        <div
          className="category-item  box mb-4"
        ...
        >
          ...
          <h4 className="room-name" style={{ whiteSpace: "nowrap" }}>
            Deluxe Room
          </h4>
          <label style={{ marginLeft: "-70px", marginTop: "-40px" }}>
            ROOM RATES EXCLUSIVE OF TAX
          </label>
          <br />
          <label style={{ marginLeft: "-190px", marginTop: "-15px" }}>
            MAX 5 Guests
          </label>
          ...
          {addRoomButtonVisible && (
            <button
              ...
              style={{ marginLeft: "880px", marginTop: "70px" }}
            >
              Add Rooms
            </button>
          )}
