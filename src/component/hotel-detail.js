    ...
    <div>
      ...
      <section className="breadcrumb-main pb-20 pt-14" style={{ backgroundImage: 'url(assets/images/bg/bg1.jpg)' }}>
        ...
        <div className="breadcrumb-outer">
          <div className="container">
            <div className="breadcrumb-content">
              ...
              <nav aria-label="breadcrumb" className="d-block">
                <img src={hotelData.hotel_logo} alt="image.png" height="130px" width="150px" style={{ marginTop: "-100px", marginLeft: "-1350px", borderRadius: "50%" }} />
                <h4 className="mb-0" style={{ marginLeft: "-850px", marginTop: "-130px" }}>{hotelData.hotel_name}</h4>
                <label className="mb-0" style={{ marginLeft: "-610px", marginTop: "10px", color: "#ACD037" }}>Address-</label>
                <label className="mb-0" style={{ marginLeft: "10px", marginTop: "10px", color: "#ACD037" }}>{hotelData.hotel_address_line_1}</label>
                <label className="mb-0" style={{ marginLeft: "10px", marginTop: "10px", color: "#ACD037" }}>{hotelData.hotel_address_line_2}</label>
          ...
          <label style={{ marginLeft: "60px", marginTop: "40px", color: "#ACD037", textAlign: "left" }}>{hotelData.hotel_description}</label>
        </div>
      ...
      <div class="row d-flex align-items-center justify-content-between">
        ...
        <div class="col-lg-2 mb-2" style={{ marginLeft: "-20px" }}>
          <div class="form-group">
        ...
        <div class="col-lg-2" style={{ marginTop: "20px" }}>
